   ...
   const element= document.createElement("div");
    element.innerHTML=`
     <div class="menu-container"> 
          ...
          <div class="menu-item">
            <img src="./images/kremaAndMksrat.jpg" alt="" id="kremaAndMksrat">
         ...
         <div class="menu-item">
         <img src="./images/chickenBBQ.jpg" alt="" id="chickenBBQ">
      ...
      <div class="menu-item">
      <img src="./images/Nutella.jpg" alt="" id="Nutella">
      <h2>Nutella Pasty</h2>
      <p>Indulge in pure chocolate hazelnut bliss with our Nutella Dream. Flaky, golden puff pastry is filled to bursting with rich, Nutella spread. We dust it with powdered sugar for an extra touch of sweetness and serve it warm for a delightful anytime treat.</p>
          ...
          <div class="menu-item">
      <img src="./images/rockets.jpg" alt="" id="rockets">
